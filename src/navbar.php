        ...
        <ul class="nav navbar-nav">
          ...
          <li id="addContent" class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li id="addMovieDirectorRelation"><a href="add_m_d_r.php">Add Movie/Director Relation</a></li> 
            </ul>
          </li>
          <form method="GET" action="search.php" class="navbar-form navbar-left">
            <div class="form-group">
              <label for="search-term"></label>
              <input type="text" class="form-control" placeholder="Search Actor or Movie" id="search-term" name="search-term">
            </div>
